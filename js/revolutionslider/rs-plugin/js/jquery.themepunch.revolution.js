						...
						if (!container.hasClass("revslider-initialised")) {
									...
									if (is_mobile()) {
										container.find('.tp-caption').each(function() {
											...
											if (nextcaption.data('autoplayonlyfirsttime') == false || nextcaption.data('autoplayonlyfirsttime')=="false")
													nextcaption.data('autoplayonlyfirsttime',"false");
											if (nextcaption.data('autoplay')==false || nextcaption.data('autoplay')=="false")
