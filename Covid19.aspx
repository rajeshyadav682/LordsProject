<%@ Page Title="" Language="C#" MasterPageFile="~/DefaultMasterPage.master" AutoEventWireup="true" CodeFile="Covid19.aspx.cs" Inherits="Covid19" %>
            ...
            <div class="box box-default" style="background-color:rgba(255, 255, 255, 0.80);">
                <div class="form-horizontal" >
                    ...
                    <div id="listPlacement"  class="gradientBoxesWithOuterShadows" ></div>
                        <asp:TextBox ID="txtemployee" runat="server" CssClass="form-control" placeholder="Type Employee Name or Code" AutoPostBack="true" OnTextChanged="txtemployee_TextChanged"></asp:TextBox>
                        ...
                        <div class="tab-content">
                              ...
                              <div class="col-md-3">
                                 <table width="1000px">
                                     <tr>
                                         ...
                                         <td align="left" >
                                            <asp:RadioButtonList ID="RdApp" runat="server" RepeatDirection="Horizontal" CssClass="Space">                                                                                                    
                                            <asp:ListItem Value="1" Selected="True">Applicable &nbsp;&nbsp;&nbsp;&nbsp;</asp:ListItem>
                                                      <asp:ListItem Value="2">Not Applicable&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                      </asp:ListItem>
                                            </asp:RadioButtonList>
                                         </td>
                            ...
                            <div class="tab-pane fade" id="DivINTHousingLoan" runat="server">
                             <div class="col-md-3">
                                 <table width="1000px">
                                     <tr><td>
                                    <asp:RadioButtonList ID="RdAppM" runat="server" RepeatDirection="Horizontal" CssClass="Space">                                                    
                            ...
                            <div class="tab-pane fade" id="DivOtherInCome" runat="server">
                             <div class="col-md-3">
                                 <table width="1000px">
                                     <tr><td>
                                    <asp:RadioButtonList ID="RdAppW" runat="server" RepeatDirection="Horizontal" CssClass="Space">                                                    
                                                
                                         <asp:ListItem Value="1" Selected="True">IsApplicable &nbsp;&nbsp;&nbsp;&nbsp;</asp:ListItem>
                                                      <asp:ListItem Value="2">NotApplicable&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                      </asp:ListItem>
                                    </asp:RadioButtonList>
                                         </td>                                       
                                     ...
                                     <tr>
                                      ...
                                      <tr style="width:1000px">
                                         <td>
                                            <h4 style="font:100;">Applicable</h4> 
                                    </td></tr>  
                                     <tr style="width:1000px">
                                          <td  style="width:1000px" colspan="2"><span>1.</span>
                            ...
                            <div class="tab-pane fade" id="Div1017" runat="server">
                                <div class="col-md-3">
                                 <table width="1000px">
                                     <tr><td>
                                    <asp:RadioButtonList ID="RdAppC" runat="server" RepeatDirection="Horizontal" CssClass="Space">                                                    
                                    ...
                                    <asp:label ID="Label73" runat="server" Text="Downloaded Aarogya Setu App in your Mobile Phone" CssClass="control-label" ></asp:label>
                                     ...
                                     <tr style="width:1000px">
                                          <td  style="width:1000px" colspan="2"><span>15.</span>
                                    <asp:label ID="Label74" runat="server" Text="Will you travel to office with your own conveyance" CssClass="control-label" ></asp:label>
                            ...
                            <div class="tab-pane fade" id="DivOther" runat="server">
                             <div class="col-md-3">
                                 <table width="1000px">
                                     <tr><td>
                                    <asp:RadioButtonList ID="RdAppC2" runat="server" RepeatDirection="Horizontal" CssClass="Space">                                                    
